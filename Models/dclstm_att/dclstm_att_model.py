...
from Models.dclstm_att.dclstm_att_cell import DCLSTMCellAtt


class DCLSTMAttModel(object):
    def __init__(self, is_training, batch_size, scaler, adj_mx, **model_kwargs):
        ...
        cell = DCLSTMCellAtt(rnn_units, adj_mx, max_diffusion_step=max_diffusion_step, num_nodes=num_nodes,
                             filter_type=filter_type, batch_size=batch_size)
        cell_with_projection = DCLSTMCellAtt(rnn_units, adj_mx, max_diffusion_step=max_diffusion_step,
                                             num_nodes=num_nodes,
