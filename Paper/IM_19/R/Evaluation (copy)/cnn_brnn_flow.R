...
setEPS()
postscript("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Evaluation/cnn_brnn_flow_11_10_day_10.eps",height=2.5, width=4.5)
par(mar=c(4, 4, 0.5, 0.0) + 0.1)
par(mgp = c(3, 1, 0))

data <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Evaluation/cnn_brnn_flow_11_10_day_10.csv",header=T,sep=",")
...
measured_points <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Evaluation/cnn_brnn_flow_11_10_day_10_measured_points.csv",header=T,sep=",")
...
plot(c(x_min, x_max + 1),c(y_min,y_max + 2), type="n", cex.lab = 1.1, cex.axis=1.5, xlab="Timestep", ylab="Traffic volume (Mbps)")
