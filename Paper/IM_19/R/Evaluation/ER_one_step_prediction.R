data<-read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Evaluation/ER_one_step_prediction.csv",header=T,sep=",")
max_x <- max(data$p)
min_x <- min(data$p)
...
setEPS()
postscript("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Evaluation/ER_one_step_prediciton.eps",height=3, width=4.5)
