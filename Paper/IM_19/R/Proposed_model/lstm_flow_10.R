...
setEPS()
postscript("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_10.eps",height=2.5, width=3.5)
par(mar=c(3, 3, 0, 0) + 0.1)
par(mgp = c(2, 1, 0))

data <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_10.csv",header=T,sep=",")
...
measured_points <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_measured_points_10.csv",header=T,sep=",")
...
legend("topright",c("Actual Traffic", "Predicted Traffic", "Measured Points"), lty=c(1,1, NA), pch=c(NA, NA, '*'), col=c("black", "red", "darkblue"), cex=0.9, xjust=0.5, yjust=0.5, ncol=1)
