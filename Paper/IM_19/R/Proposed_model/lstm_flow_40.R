...
setEPS()
postscript("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_40.eps",height=2.5, width=3.5)
par(mar=c(3, 3, 0, 0) + 0.1)
par(mgp = c(2, 1, 0))

data <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_40.csv",header=T,sep=",")
...
measured_points <- read.table("/home/anle/Dropbox/Research/TM_estimation_RNN/Paper/IM_19/R/Proposed_model/lstm_flow_142_day_10_measured_points_40.csv",header=T,sep=",")
