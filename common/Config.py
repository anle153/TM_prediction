...
FW_LSTM_BEST_CHECKPOINT = 50
BW_LSTM_BEST_CHECKPOINT = 50
...
FWBW_CONV_LSTM_N_EPOCH = 150
FWBW_CONV_LSTM_BATCH_SIZE = 256

FWBW_CONV_LSTM_LAYERS = 2
FWBW_CONV_LSTM_FILTERS = [2, 4]
...
FWBW_CONV_LSTM_TESTING_TIME = 10
FW_BEST_CHECKPOINT = 108
BW_BEST_CHECKPOINT = 127
...
# CONV_LSTM_LAYERS = 3
# CONV_LSTM_FILTERS = [4, 8, 8]
# CONV_LSTM_KERNEL_SIZE = [[3, 3], [5, 5], [3, 3]]
# CONV_LSTM_STRIDES = [[1, 1], [1, 1], [1, 1]]
# CONV_LSTM_DROPOUTS = [0.25, 0.25, 0.25]
# CONV_LSTM_RNN_DROPOUTS = [0.25, 0.25, 0.25]
