...
CONV_LSTM_LAYERS = 4
CONV_LSTM_FILTERS = [8, 16, 32, 16]
CONV_LSTM_KERNEL_SIZE = [[3, 3], [5, 5], [5, 5], [3, 3]]
CONV_LSTM_STRIDES = [[1, 1], [1, 1], [1, 1], [1, 1]]
CONV_LSTM_DROPOUTS = [0.5, 0.5, 0.5, 0.5]
CONV_LSTM_RNN_DROPOUTS = [0.5, 0.5, 0.5, 0.5]
