...
def print_dclstm_info(mode, config):
    print('----------------------- INFO -----------------------')
...
if __name__ == '__main__':
    ...
    print_dclstm_info(args.mode, config)
    if args.mode == 'train':
        train_dclstm(config)
    elif args.mode == 'evaluate' or args.mode == 'evaluation':
        evaluate_dclstm(config)
    else:
        test_dclstm(config)
    # get_results(data)
