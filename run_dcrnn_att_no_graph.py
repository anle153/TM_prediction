...
from Models.dcrnn_att_no_graph.dcrnn_supervisor_att_no_graph import DCRNNSupervisor


def print_dcrnn_att_ng_info(mode, config):
    print('----------------------- INFO -----------------------')
...
def evaluate_dcrnn_att_ng(config):
    print('|-- Run model testing dcrnn_weighted.')
...
if __name__ == '__main__':
    ...
    print_dcrnn_att_ng_info(args.mode, config)
    if args.mode == 'train':
        train_dcrnn_att_ng(config)
    elif args.mode == 'evaluate' or args.mode == 'evaluation':
        evaluate_dcrnn_att_ng(config)
    else:
        test_dcrnn_att_ng(config)
    # get_results(data)
